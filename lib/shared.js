const { rules: baseBestPracticesRules } = require('bi-eslint-es-be/rules/best-practices');
const { rules: baseErrorsRules } = require('bi-eslint-es-be/rules/errors');
const { rules: baseES6Rules } = require('bi-eslint-es-be/rules/es6');
const { rules: baseImportsRules } = require('bi-eslint-es-be/rules/imports');
const { rules: baseStyleRules } = require('bi-eslint-es-be/rules/style');
const { rules: baseVariablesRules } = require('bi-eslint-es-be/rules/variables');
