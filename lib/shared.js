const { rules: baseBestPracticesRules } = require('eslint-config-bi-es-be/rules/best-practices');
const { rules: baseErrorsRules } = require('eslint-config-bi-es-be/rules/errors');
const { rules: baseES6Rules } = require('eslint-config-bi-es-be/rules/es6');
const { rules: baseImportsRules } = require('eslint-config-bi-es-be/rules/imports');
const { rules: baseStyleRules } = require('eslint-config-bi-es-be/rules/style');
const { rules: baseVariablesRules } = require('eslint-config-bi-es-be/rules/variables');
...
module.exports = {
  ...
  rules: {
    ...
    // Prevents implicit coercion when using non-string values in template expressions
